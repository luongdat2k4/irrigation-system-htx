          ...
          <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 gap-4">
              <DeviceCard
                ...
                :last-update="devices.light.lastUpdate"
              />
              <DeviceCard
                ...
                :last-update="devices.irrigation.lastUpdate"
              />
              <DeviceCard
                ...
                :icon="Cpu"
                on-text="Đang giám sát"
                off-text="Thủ công"
                active-bg-class="bg-emerald-600"
                :last-update="devices.auto.lastUpdate"
              />
            </div>
          </div>
